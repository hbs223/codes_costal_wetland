...
This script is used to calculate landscape diversity.
"""
...
if __name__ == '__main__':
   # year = 2000
    ...
    convert_arr_from_float2int(sub_im_arrays , enlargement_factor = 1000 , convert_type = convert_type)  
    ...
    # output tif
    ###########################################################################################################################
    name = r"E:\Desktop\中国滨海湿地数据集\output\中国滨海湿地_diversity_{}.tif".format(year)
    mat = final_data
