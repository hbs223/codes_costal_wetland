...
This script is used to calculate cohesion.
"""
...
if __name__ == '__main__':
    ...
    convert_arr_from_float2int(sub_im_arrays , enlargement_factor = 100 , convert_type = convert_type) 
    ...
    # output tif
    #####################################################################################
    name = r"E:\Desktop\中国滨海湿地数据集\output\中国滨海湿地_cohesion_{}.tif".format(year)
    mat = final_data
